...
<section class="panel">
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal bucket-form" method="POST" action="{{ route('admin.products.update', $products->products_id) }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <!-- Product Name -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug', $products->slug) }}" required>
                    @error('slug')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="so_luong" class="form-control" value="{{ old('so_luong', $products->so_luong) }}" required>
                    @error('so_luong')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" id="code_id" name="code_id" class="form-control" value="{{ old('code_id', $products->code_id) }}" required>
                    @error('code_id')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                    <!-- Stylish button -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="trong_luong" class="form-control" value="{{ old('trong_luong', $products->trong_luong) }}" required>
                    @error('trong_luong')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="ham_chat_lieu" class="form-control" value="{{ old('ham_chat_lieu', $products->ham_chat_lieu) }}" required>
                    @error('ham_chat_lieu')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="loai_da_chinh" class="form-control" value="{{ old('loai_da_chinh', $products->loai_da_chinh) }}" required>
                    @error('loai_da_chinh')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="kich_thuoc_da" class="form-control" value="{{ old('kich_thuoc_da', $products->kich_thuoc_da) }}" required>
                    @error('kich_thuoc_da')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="mau_da_chinh" class="form-control" value="{{ old('mau_da_chinh', $products->mau_da_chinh) }}" required>
                    @error('mau_da_chinh')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="hinh_dang_da" class="form-control" value="{{ old('hinh_dang_da', $products->hinh_dang_da) }}" required>
                    @error('hinh_dang_da')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="number" name="sl_da_chinh" class="form-control" value="{{ old('sl_da_chinh', $products->sl_da_chinh) }}" required>
                    @error('sl_da_chinh')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="number" name="sl_da_phu" class="form-control" value="{{ old('sl_da_phu', $products->sl_da_phu) }}" required>
                    @error('sl_da_phu')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <select name="status" class="form-control m-bot15" required>
                        <option value="1" {{ $products->status == 1 ? 'selected' : '' }}>Hiển thị</option>
                        <option value="0" {{ $products->status == 0 ? 'selected' : '' }}>Không hiển thị</option>
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-6">
                    <select name="category_id" class="form-control" required>
                        ...
                        <option value="{{ $parentCategory->parent_categorie_id }}"
                            @if ($parentCategory->parent_categorie_id == old('category_id', $products->category_id)) selected @endif>
                            {{ $parentCategory->name }}
                        </option>
                        @foreach ($parentCategory->categories as $category)
                        <option value="{{ $category->category_id }}" style="padding-left: 20px;"
                            @if ($category->category_id == old('category_id', $products->category_id)) selected @endif>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <img src="{{ asset('public/admin/images/products/' . $products->images) }}" alt="Current Image" id="currentImage" style="max-width: 100%; height: auto;">
                    <br><br>
